#############################################################################
# Description: Code for completing the final exam of BUSA 603 for FALL 2023.#
# 																			                                    #	
# Last Update Date:  10/26/23      										                      #
#                                          									                #
# Last Update Date Comments:												                        #
#	A) 10/26/23 - Version 1 of code.											                    #
#																			                                      #
# Inputs:                                                                   #
...
outpath <- "C:/Users/bkwei/R_projects/BUSA-603/BUSA_603_Moderated_Regression_Final/Output/"
...
beta_0 <- 650 # 595 # TDP
beta_1 <- 35 # 30 # GRPs
delta_1 <- 55000 # 35000 # Dummy Variable, say for coupon drop
gamma_1 <- 110 # 150 # Interaction for coupons and grps

# Data Preparation for Regression 1
...
constant <- 4.0 #5 
alpha1 <- 850 # 1500/constant # Intercept
beta0 <- 200 # 595/constant # TDP
beta1 <- 30 # 150/constant # Spotify ... 
beta2 <- 45 # 305/constant # National Radio                      
gamma1 <- 0.70 # 1.5/constant # Interaction of Spotify and National Radio
